    ...
    <div className="min-h-screen bg-stone-950 text-stone-100 font-sans selection:bg-amber-500 selection:text-stone-950">
      ...
      <header className="relative py-16 sm:py-24 px-6 border-b border-stone-800/80 overflow-hidden text-center">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h1 className="font-serif text-4xl sm:text-6xl font-light text-stone-100 tracking-widest mb-6">
            Nuestra <span className="italic text-amber-400">Historia</span>
          </h1>
          <p className="text-stone-300 font-sans font-light leading-relaxed text-base sm:text-lg">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-5">
            <span className="text-xs font-display text-amber-400 uppercase tracking-widest block">
              Quienes Somos
            </span>
            <h2 className="font-serif text-2xl sm:text-3xl font-light tracking-wide">
              Pasión por la orfebrería de alta pureza
            </h2>
            <p className="text-sm text-stone-300 font-sans font-light leading-relaxed">
          ...
          <div className="p-8 rounded-3xl bg-stone-900/60 border border-stone-800 space-y-6">
            <div className="border-l-2 border-amber-500 pl-4">
              <h3 className="font-serif text-lg text-amber-300 tracking-wide mb-1">Garantía de Por Vida</h3>
            ...
            <div className="border-l-2 border-amber-500 pl-4">
              <h3 className="font-serif text-lg text-amber-300 tracking-wide mb-1">Avalúos Precisos</h3>
              <p className="text-xs text-stone-400 font-sans leading-relaxed">
            ...
            <div className="border-l-2 border-amber-500 pl-4">
              <h3 className="font-serif text-lg text-amber-300 tracking-wide mb-1">Envíos 100% Asegurados</h3>
              <p className="text-xs text-stone-400 font-sans leading-relaxed">
        ...
        <section className="border-t border-stone-800/80 pt-16">
          <div className="text-center max-w-xl mx-auto mb-12">
            ...
            <h2 className="font-serif text-3xl font-light text-stone-100 tracking-widest">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-stone-900/40 border border-stone-800 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-serif text-lg text-stone-100 tracking-wide mb-2">Orfebrería a Medida</h3>
                <p className="text-xs text-stone-400 font-sans leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-stone-900/40 border border-stone-800 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-serif text-lg text-stone-100 tracking-wide mb-2">Transparencia Total</h3>
                <p className="text-xs text-stone-400 font-sans leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-stone-900/40 border border-stone-800 flex flex-col justify-between">
              <div>
                <span className="text-2xl mb-4 block">📍</span>
                <h3 className="font-serif text-lg text-stone-100 tracking-wide mb-2">Sede Física</h3>
                <p className="text-xs text-stone-400 font-sans leading-relaxed">
        ...
        <section className="text-center py-12 px-6 rounded-3xl bg-gradient-to-b from-stone-900/80 to-stone-950 border border-stone-800 max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-display font-bold text-xs uppercase tracking-wider transition-all shadow-[0_0_20px_rgba(245,158,11,0.3)]"
            >
              Contactar por WhatsApp
            </a>
            <Link
              href="/catalogo"
              className="px-6 py-3.5 rounded-xl border border-stone-700 hover:border-amber-500 hover:text-amber-300 text-xs font-display font-semibold uppercase tracking-wider transition-all"
            >
